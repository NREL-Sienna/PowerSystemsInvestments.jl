...
function _show_method(io::IO, template::InvestmentProblemTemplate, backend::Symbol; kwargs...)
    table = [
    ...
    println(io)
    header = ["Technology Type", "Investment Formulation", "Operations Formulation", "Slacks"]
